...
//                      $('#xuanze-box').addClass('transparent').removeClass('posf');
                        
//                  	$('#xuanze-box').removeClass('msx-hide');
                    } else {
                        $(options.valve).addClass('posf').removeClass('transparent');
//                      $('#xuanze-box').addClass('posf').removeClass('transparent');
//                      $('#xuanze-box').addClass('msx-hide');
                    }
                });
