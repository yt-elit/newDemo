$(function (){
    ...
    if(key){
        ...
        html += '<a href="javascript:void(0);" class="gotop">返回顶部</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2005-2016 <a href="javascript:void(0);">北京科美互动</a>版权所有' + "</div>--></div>";
      ...
      if (cart_count > 0) {
		...
		+'<li><a href="'+WapSiteUrl+'/tmpl/renwuguangchang.php"><i class="search"></i><p>任务广场</p></a></li>'
