...
var reset = true;
var orderKey = '';
var payment_code_type = 2;
var zhifu_type = 1;//支付方式 1 微信   2 支付宝

var order_sn = geiGet('order_sn',false);
$('#order_key').val(order_sn);
...
$(function(){
    ...
    function evaluationOrder() {
        ...
        login_k( 'tmpl/member/member_evaluation.html?order_id=' + orderId , 'member_evaluation' );
...
//      location.href = WapSiteUrl + '/tmpl/member/member_evaluation.html?order_id=' + orderId;
    ...
    function evaluationAgainOrder() {
        ...
        login_k( 'tmpl/member/member_evaluation_again.html?order_id=' + orderId , 'member_evaluation_again' );
...
//      location.href = WapSiteUrl + '/tmpl/member/member_evaluation_again.html?order_id=' + orderId;
    ...
    function viewOrderDelivery() {
        var orderId = $(this).attr('order_id');
        login_k( 'tmpl/member/order_delivery.html?order_id=' + orderId , 'order_delivery' );
