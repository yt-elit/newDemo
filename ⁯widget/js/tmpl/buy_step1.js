...
var vip_buy	=	getQueryString('vip_buy');
...
$(function() {
    ...
    var _init = function (address_id) {
    	...
    	if( pintuan_id ){
    		var op	=	{key:key,cart_id:cart_id,ifcart:ifcart,address_id:address_id,pintuan_id:pintuan_id};
    		
    	}else if( vip_buy ){
    		var op	=	{key:key,cart_id:cart_id,ifcart:ifcart,address_id:address_id,vip_buy:1};
    		
    	}else{
    		var op	=	{key:key,cart_id:cart_id,ifcart:ifcart,address_id:address_id};
    	}
...
//      }
        ...
        if( order_pintuan ){
        	op.order_pintuan = order_pintuan;
        }
