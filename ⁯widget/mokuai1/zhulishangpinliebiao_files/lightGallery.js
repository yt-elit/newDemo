...
//              this.slideTo();
            ...
            enableTouch: function() {
                ...
                if (isTouch) {
                    ...
                    $('body').bind('touchmove.lightGallery', function(e) {
                        var orig = e.originalEvent;
                        endCoords = orig.targetTouches[0];
                        e.preventDefault();
                    });
                    $('body').bind('touchend.lightGallery', function(e) {
            ...
            loadObj: function(r, index) {
                var $this = this;
                $slide.eq(index).find('.object').bind('load error', function() {
...
//          },
        ...
        plugin.destroy = function(d) {
            ...
            clearInterval(interval);
            if (d === true) {
                $children.unbind('click touch touchstart');
            }
            $('.lightGallery').unbind('mousedown mouseup');
            $('body').unbind('touchstart.lightGallery touchmove.lightGallery touchend.lightGallery');
            $(window).unbind('resize.lightGallery keyup.lightGallery');
